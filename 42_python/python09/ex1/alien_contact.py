...
class AlienContact(BaseModel):
    """validated record of reported alien contact"""
    ...
    def check_business_rules(self) -> "AlienContact":
        """enforce cross-field business rules for contact reports"""
...
def extract_message(error: ValidationError) -> str:
    """return first validation error message, prefix stripped"""
    message = error.errors()[0]["msg"]
    return message.removeprefix("Value error, ")


def display_contact(contact: AlienContact) -> None:
    """summary of validated contact report"""
...
def main() -> None:
    ...
    contact = AlienContact(
        ...
        timestamp=datetime(2024, 3, 12, 22, 15),
